...
class Metaclass_AddTwoInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rov_interfaces.srv import _add_two_ints
...
class AddTwoInts(metaclass=Metaclass_AddTwoInts):
    from rov_interfaces.srv._add_two_ints import AddTwoInts_Request as Request
    from rov_interfaces.srv._add_two_ints import AddTwoInts_Response as Response
